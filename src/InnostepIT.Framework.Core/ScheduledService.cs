...
public class ScheduledService<THosted> : IHostedService, IDisposable
{
    ...
    public ScheduledService(ILogger<ScheduledService<THosted>>? logger, IScheduledService? scheduledService,
        int intervalInMilliseconds = Timeout.Infinite, bool autoStart = true)
    {
